...
- ***RFID ID***: This is used to get the unique 10-character ID number of the RFID card.
- ***RFID Attendance***: This is used to display the student name and "present" on the LCD based on the RFID number.
